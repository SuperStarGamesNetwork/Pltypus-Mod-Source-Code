...
public class EntityPlatypus extends EntityTameable{
	   ...
	   private float field_70926_e;
	    ...
	    public EntityPlatypus(World par1World)
	    {
	        super(par1World);
	    ...
	    {
	        return this.isTamed() ? "/mob/Platypus.png" : (this.isAngry() ? "/mob/Platypus.png" : super.getTexture());
	    }
	    ...
	    {
	        return Platipusmod.Platypusbeek.itemID;
	    }
	    ...
	    public boolean interact(EntityPlayer par1EntityPlayer)
	    {
	        ...
	        else if (itemstack != null && itemstack.itemID == Item.seeds.itemID && !this.isAngry())
	        {
	            if (!par1EntityPlayer.capabilities.isCreativeMode)
	            {
	                --itemstack.stackSize;
	     ...
	     */
	    public EntityPlatypus spawnBabyAnimal(EntityAgeable par1EntityAgeable)
	    {
	        EntityPlatypus entityPlatypus = new EntityPlatypus(this.worldObj);
	        String s = this.getOwnerName();

	        if (s != null && s.trim().length() > 0)
	        {
	            entityPlatypus.setOwner(s);
	            entityPlatypus.setTamed(true);
	        }
	    ...
	    public boolean canMateWith(EntityAnimal par1EntityAnimal)
	    {
	        ...
	        else if (!(par1EntityAnimal instanceof EntityPlatypus))
	        {
	            return false;
	        }
	        else
	        {
	            EntityPlatypus entityPlatypus = (EntityPlatypus)par1EntityAnimal;
	            return !entityPlatypus.isTamed() ? false : (entityPlatypus.isSitting() ? false : this.isInLove() && entityPlatypus.isInLove());
	        }
	    }
